        ...
        <div class="el-picker-panel__body">
          ...
          <div class="el-date-picker__header" v-show="currentView !== 'time'">
            <button type="button" 
              ...
              <i class="jo-icon jo-icon-double-arrow-left"></i>
            </button>
            <button type="button" @click="prevMonth"  v-show="currentView === 'date'" class="el-picker-panel__icon-btn el-date-picker__prev-btn el-icon-arrow-left">
              <i class="jo-icon jo-icon-left-arrow"></i>
            </button>
            <span
            ...
            <button
              ...
              <i class="jo-icon jo-icon-double-arrow-right"></i>
            </button>
            <button
              type="button"
              @click="nextMonth"
              ...
              <i class="jo-icon jo-icon-right-arrow"></i>
            </button>
          </div>
