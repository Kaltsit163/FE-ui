<template>
    ...
    <ul :class="wrapClasses" :style="styles" v-else>
        ...
        <li
            ...
            :class="prevClasses"
            @click="prev">
            <a><i class="jo-icon jo-icon-left-arrow"></i></a>
        </li>
        <li title="1" :class="firstPageClasses" @click="changePage(1)"><a>1</a></li>
        <li :title="t('i.page.prev5')" v-if="currentPage - 3 > 1" :class="[prefixCls + '-item-jump-prev']" @click="fastPrev">
            <a><i class="jo-icon jo-icon-double-arrow-left"></i></a></li>
        ...
        <li :title="t('i.page.next5')" v-if="currentPage + 3 < allPages" :class="[prefixCls + '-item-jump-next']" @click="fastNext">
            <a><i class="jo-icon jo-icon-double-arrow-right"></i></a></li>
        <li :title="allPages" v-if="allPages > 1" :class="lastPageClasses" @click="changePage(allPages)"><a>{{ allPages }}</a></li>
        <li
            :title="t('i.page.next')"
            :class="nextClasses"
            @click="next">
            <a><i class="jo-icon jo-icon-right-arrow"></i></a>
        </li>
        <Options
